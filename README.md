...
## Pemasangan program pada Raspberry Pi

Program ini dapat dipasang dengan menyalin keseluruhan isi MicroSD dari Raspberry Pi yang sudah dipasangi program ini (lihat bagian 'Referensi'), atau dipasang dari awal dengan langkah-langkah berikut:
...
- [Menyalin MicroSD untuk Raspberry Pi](http://www.makeuseof.com/tag/easily-clone-your-sd-card-for-trouble-free-raspberry-pi-computing/)